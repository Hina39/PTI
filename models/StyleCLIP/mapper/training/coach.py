    ...
    def validate(self):
        ...
        for batch_idx, batch in enumerate(self.test_dataloader):
            ...
            with torch.no_grad():
                ...
                x, _ = self.net.decoder(
                    [w], input_is_latent=True, randomize_noise=True, truncation=1
                )
                w_hat = w + 0.1 * self.net.mapper(w)
                x_hat, _ = self.net.decoder(
                    [w_hat], input_is_latent=True, randomize_noise=True, truncation=1
                )
